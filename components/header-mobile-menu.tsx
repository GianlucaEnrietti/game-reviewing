    ...
    <div className="md:hidden">
      ...
      {isMounted && (
        <>
          ...
          <aside
            className={`fixed right-0 top-0 z-40 h-screen w-72 max-w-[85vw] border-l border-slate-700 bg-slate-950 p-5 shadow-2xl transition-transform duration-300 ease-out ${
